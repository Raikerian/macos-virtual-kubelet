...
var (
	buildVersion = "local"
	buildTime    = "N/A"
	k8sVersion   = "v1.26.8" // This should follow the version of k8s.io/kubernetes we are importing
)
...
func main() {
	...
	opts.Version = strings.Join([]string{k8sVersion, "vk-macos", buildVersion}, "-")
