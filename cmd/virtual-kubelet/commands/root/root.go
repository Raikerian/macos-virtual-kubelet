...
import (
	...
	"github.com/raikerian/macos-virtual-kubelet/provider"
...
func runRootCommand(ctx context.Context, c Opts) error {
	...
	cm, err := nodeutil.NewNode(hostName, newProvider, func(cfg *nodeutil.NodeConfig) error {
